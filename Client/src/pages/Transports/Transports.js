...
export const Transports = () => {
    ...
    return ( <
        ...
        <p className = "af-body--content" > Calculez les émissions de Gaz à effet de Serre dues à vos trajets.<br></br> Et comparez-les avec d'autres sources d'émission.</p> <
        ...
        i1 <
        /span> <
        HelpButton classModifier = "small"
        mode = "hover" >
        <
        ul >
        <
        li > Prix: { i1Data.coutMensuel }€
        /mois</li >
        <
        li > Ressources: < /li> <
        ul >
...

        {
            hasResults && ( <
                ...
                <
                CardPrice title = "Internet"
                autoScaleCost = { internetAppAutoScaleCost }
                cost = { costForType }
                /> <
                CardPrice title = "Internet Entreprise"
                autoScaleCost = { internetCompanyAppAutoScaleCost }
                cost = { costForType }
                /> <
                CardPrice title = "Distributeur"
                autoScaleCost = { distributeurAppAutoScaleCost }
                cost = { costForType }
                /> <
                CardPrice title = "Administratif"
                autoScaleCost = { administratifAppAutoScaleCost }
                cost = { costForType }
                />

                <
                CardPrice title = "AutoScale le samedi"
                autoScaleCost = { autoScaleCost }
                cost = { cost }
                /> <
                CardPrice title = "AutoScale soir du lundi au vendredi"
                autoScaleCost = { autoScaleWorkingHoursCost }
                cost = { cost }
                /> <
                CardPrice title = "AutoScale soir et week-end"
